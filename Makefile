...
DIST_COMMON = README $(am__configure_deps) $(srcdir)/Doxyfile.in \
	...
	$(srcdir)/chewing.pc.in $(srcdir)/libchewing.spec.in \
...
CONFIG_CLEAN_FILES = chewing.pc libchewing.spec Doxyfile
SOURCES =
DIST_SOURCES =
...
ACLOCAL = ${SHELL} /mnt/data1/Work/991/Misc/libchewing-0.3.2/autotools/missing --run aclocal-1.10
AMTAR = ${SHELL} /mnt/data1/Work/991/Misc/libchewing-0.3.2/autotools/missing --run tar
AR = ar
AUTOCONF = ${SHELL} /mnt/data1/Work/991/Misc/libchewing-0.3.2/autotools/missing --run autoconf
AUTOHEADER = ${SHELL} /mnt/data1/Work/991/Misc/libchewing-0.3.2/autotools/missing --run autoheader
AUTOMAKE = ${SHELL} /mnt/data1/Work/991/Misc/libchewing-0.3.2/autotools/missing --run automake-1.10
AWK = gawk
CC = gcc
CCDEPMODE = depmode=gcc3
CFLAGS = -g -O2 -g -fvisibility=hidden
CHECK_CFLAGS = 
CHECK_LIBS = 
CPP = gcc -E
CPPFLAGS = 
...
LN_S = ln -s
LTLIBOBJS = 
MAKEINFO = ${SHELL} /mnt/data1/Work/991/Misc/libchewing-0.3.2/autotools/missing --run makeinfo
MKDIR_P = /bin/mkdir -p
NCURSESW_CFLAGS = 
NCURSESW_LIBS = -L/usr/lib -lncursesw
NM = /usr/bin/nm -B
NMEDIT = 
OBJEXT = o
PACKAGE = libchewing
...
PACKAGE_STRING = libchewing 0.3.2
...
STRIP = strip
VERSION = 0.3.2
abs_builddir = /mnt/data1/Work/991/Misc/libchewing-0.3.2
abs_srcdir = /mnt/data1/Work/991/Misc/libchewing-0.3.2
abs_top_builddir = /mnt/data1/Work/991/Misc/libchewing-0.3.2
abs_top_srcdir = /mnt/data1/Work/991/Misc/libchewing-0.3.2
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
am__leading_dot = .
...
install_sh = $(SHELL) /mnt/data1/Work/991/Misc/libchewing-0.3.2/autotools/install-sh
